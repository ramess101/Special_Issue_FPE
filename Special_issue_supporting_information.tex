...
%	
    ...
    \section{Additional simulation details} \label{Additonal simulation details}
...
%	Following ``Best Practices'', we compute $\eta$ with several different production times (1, 2, 4, and 8 ns) for select systems to verify that the results are indistinguishable (see Supporting Information).
    ...
    \begin{figure}[htb!]
    	...
    	\caption{Green-Kubo integrals for the most viscous systems studied. Each compound was simulated with the Potoff potential. Solid lines are the average of $N_{\rm reps}$ replicates. Dashed lines are the estimated $\eta$ value after fitting. Dotted lines represent the 95 \% bootstrapped uncertainties.}
	...
	\begin{table}[H]
		...
		\begin{center}
			\begin{tabular}{|c|c|c|c|c|}
				...
				241 & 316.89 & 0.279$_{0.016}$   & 0.2664$_{6.2 \rm E-3}$ & 0.1900$_{4.3 \rm E-3}$ \\ \hline
				287 & 292.52 & 0.1691$_{3.7 \rm E-3}$ & 0.1640$_{3.7 \rm E-3}$ & 0.1327$_{2.7 \rm E-3}$ \\ \hline
				328 & 268.14 & 0.1146$_{2.5 \rm E-3}$ & 0.1168$_{1.8 \rm E-3}$ & 0.0928$_{2.0 \rm E-3}$ \\ \hline
	...
	\begin{table}[H]
		...
		\begin{center}
			\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|}
				...
				293         & 558.6$_{1.2}$                              & -0.03$_{0.91}$ & 0.1501$_{6.3 \rm E-3}$                      & 1.72$_{0.23}$                          & 0.0758$_{9.5 \rm E-3}$ & 2.71 \rm E-3$_{3.4 \rm E-4}$                     & 559.1$_{2.1}$                          & 0.1$_{1.3}$    & 0.1167$_{2.6 \rm E-3}$                      \\ \hline
