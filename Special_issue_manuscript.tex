...
%	However, this study focused on viscosities of saturated liquids.
	...
	For example, Nieto-Draghi et al. demonstrate systematic improvement in viscosity prediction for the AUA4 model by increasing the torsional barriers \cite{Nieto2006,Nieto2008}. The primary advantage of this approach is that the torsional barriers do not typically impact thermodynamic properties and, thus, the non-bonded parameters do not need to be re-optimized. 
