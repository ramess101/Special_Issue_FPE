	...
	\begin{table}[h!]
		...
		\begin{center}
			\begin{tabular}{|c|c|c|c|c|}
				...
				&                                       & Potoff            & TAMie             & TraPPE            \\ \hline
				$T^{\rm sat}$ {[}K{]} & $\rho^{\rm sat}_{\rm liq}$ [kg/m$^3$] & $\eta_{\rm liq}^{\rm sat}$ {[}Pa-s{]} & $\eta_{\rm liq}^{\rm sat}$ {[}Pa-s{]} & $\eta_{\rm liq}^{\rm sat}$ {[}Pa-s{]} \\ \hline
				356 & 753.06 & 0.0$_{0.0}$       & 0.0$_{0.0}$       & 0.0$_{0.0}$       \\ \hline
	...
	\begin{table}[]
		...
		\begin{center}
			\begin{tabular}{|c|c|c|c|c|c|c|c|}
				...
				293         & 832.65                                     & 405.1$_{6.2}$    & 5.93$_{0.64}$                          & 426.7$_{3.6}$    & 6.02$_{0.41}$                          & 260.9$_{1.1}$   & 1.790$_{0.084}$                        \\ \hline
				293         & 894.90                                     & 873.4$_{1.4}$    & 58.1$_{5.1}$                           & 880.88$_{0.81}$  & 39.6$_{3.8}$                           & 548.29$_{0.99}$ & 5.29$_{0.84}$                          \\ \hline
				293         & 832.65                                     & --                & --                                      & --                & --                                      & 719.6$_{1.1}$   & 11.7$_{1.1}$                           \\ \hline
			\end{tabular}
		\end{center}
	\end{table}
